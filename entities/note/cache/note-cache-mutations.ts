/**
 * @file entities/note/cache/note-cache-mutations.ts
 ...
 * Used in: entities/note/hooks/use-*-note-mutation.ts, cache/patch-note-in-cache.ts
...
import { aggregateMonthNotes } from "@/entities/note/transform";
