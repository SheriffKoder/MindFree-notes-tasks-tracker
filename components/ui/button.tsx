  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md border text-sm font-medium transition-colors duration-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[var(--color-accent)] disabled:pointer-events-none disabled:shadow-none [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        ghost:
          "border-transparent [color:var(--color-fg)] hover:[background-color:var(--color-interactive-accent-surface)] hover:[color:var(--color-accent)] disabled:[color:var(--color-fg-disabled)]",
        link:
          "border-transparent p-0 [color:var(--color-accent)] shadow-none underline-offset-4 hover:[color:var(--color-accent-dark)] hover:underline disabled:[color:var(--color-fg-disabled)]",
      },
      size: {
